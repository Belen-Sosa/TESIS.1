                  ...
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            ...
                            <button class="btn btn-primary btn-lg" id="add_button" onclick="limpiar()" data-toggle="modal" data-target="#productoCarniceriaModal"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Producto Carniceria</button></h1>
...
<div id="productoModal" class="modal fade">
 ...
 <!--FIN FORMULARIO VENTANA MODAL-->
  ...
  <!-- FORMULARIO VENTANA MODAL CARNICERA-->

<div id="productoCarniceriaModal" class="modal fade">
  <div class="modal-dialog tamanoModal">
    <form class="form-horizontal" method="post" id="producto_form" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Agregar Producto Carniceria</h4>
   ...
   <script> $("#procedente").change(function() {
	if($("#procedente").val() != "0"){
	  ...
	  $('#stock').prop('disabled', 'disabled');
              ...
              <div class="form-group">
                  <label  for="" class="col-lg-1 control-label">Procedente</label>

                  <div class="col-lg-9 col-lg-offset-1">
                    
                    <select onclick="document.getElementById('stock').disabled=false;" class="form-control"  name="procedente" id="procedente">
