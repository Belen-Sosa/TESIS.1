	 ...
	 <div class="col-md-12 col-sm-12 col-xs-12">
	    ...
	    <div class="box">
	       ...
	       <div class="">
				  ...
				  <h2 class="reporte_compras_general container-fluid bg-red text-white col-lg-12 text-center mh-50">REPORTE GENERAL DE COMPRAS REALIZADAS <?php echo date("Y")  ?></h2>
